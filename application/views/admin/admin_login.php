                        ...
                        <form class="form-horizontal" action="<?php echo base_url(); ?>admin/check_admin_login" method="post">
                            <fieldset>
                                ...
                                <div class="input-prepend" title="Username" data-rel="tooltip">
                                    <span class="add-on"><i class="icon-user"></i></span><input autofocus class="input-large span10" name="admin_email_address" id="username" type="text" value="" />
                                </div>
                                <div class="clearfix"></div>

                                <div class="input-prepend" title="Password" data-rel="tooltip">
                                    <span class="add-on"><i class="icon-lock"></i></span><input class="input-large span10" name="admin_password" id="password" type="password" value="" />
                                </div>
                                <div class="clearfix"></div>
