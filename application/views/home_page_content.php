<div class="container">
    <div class="jumbotron">
        <p style="color:red; font-size:28px;">English Editing Service – Maximize Your Chances of Publication in International Journals</p> 
        <p style="margin-left:2cm;">This site specializes in providing scientific and academic editing services to researchers and helps them to
            get published in high-impact factor journals globally.</p>
    </div>
</div>
...
<section>
    <div class="container">
        <div class="row">
            <div class="col-md-6" style="font-size:30px;background-color: #87BB11;"><p style="margin-left:70px;">Latest Services</p></div>
            ...
            <div class="col-md-4">
                <div style="margin-top:-52px;background-color: #87BB11;font-size:27px;">
                    <p style="margin-left:30px;">Latest Services side</p>
                </div>
                <br/>
