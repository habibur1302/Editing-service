...
<section>
    <div class="container">
        <div class="row">
            <div class="col-md-6" style="font-size:30px;background-color: #87BB11;"><p style="margin-left:70px;">Research Services</p></div>
            ...
            <div class="col-md-4">
                <div style="margin-top:-52px;background-color: #87BB11;font-size:27px;">
                    <p style="margin-left:30px;">Related Research Services</p>
                </div>
                <br/>
